...
setwd("~/All working docs/PhD/Tech Report")
library(tidyverse)
library(yarrr)
...
![Raw_Freq](C:\Users\marta\OneDrive - University of Surrey\Documents\All working docs\PhD\Tech Report\fig1_raw_freq.jpg)  
...
![Range_Freq](C:\Users\marta\OneDrive - University of Surrey\Documents\All working docs\PhD\Tech Report\fig2_range_freq.jpg)  
...
![Plots](C:\Users\marta\OneDrive - University of Surrey\Documents\All working docs\PhD\Tech Report\corr_plots_v2.jpg)
## **All frequencies pirate plots**  
  
![Plots](C:\Users\marta\OneDrive - University of Surrey\Documents\All working docs\PhD\Tech Report\fig3_freq_pirates.jpg)
...
(p value times by 4 as there are 2 types of ERPs with 2 tests used for each)    
...
From the Wilcoxon test, it seems as though ERN is much more positive in the case of Mobita compared with EasyCap and this difference is significant. This is probably caused by the latency shift for these response-locked epochs.  
P value with Bonferroni Correction = 0.031248  
(p value multiplied by 4)  
...
The difference disappears once the mean ampliude window is moved back?
There is no peak latency shift for P300? This is response specific?
