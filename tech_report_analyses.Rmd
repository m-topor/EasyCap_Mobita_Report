...
**Correlation:** τ = `r theta_cor$estimate`, p = `r theta_cor$p.value`, Bonferroni p = `r theta_cor$p.value*12`  
...
**Correlation:** τ = `r alpha_cor$estimate`, p = `r alpha_cor$p.value`, Bonferroni p = `r alpha_cor$p.value*12`  
...
**Correlation:** τ = `r lbeta_cor$estimate`, p = `r lbeta_cor$p.value`, Bonferroni p = `r lbeta_cor$p.value*12`  
...
**Correlation:** τ = `r hbeta_cor$estimate`, p = `r hbeta_cor$p.value`, Bonferroni p = `r hbeta_cor$p.value*12`  
...
P300_cor <- cor.test(df_P300$Pz_E, df_P300$Pz_M, method="kendall")
...
**Correlation:** τ = `r P300_cor$estimate`, p = `r P300_cor$p.value`, Bonferroni p = `r P300_cor$p.value*14`  
  
**Wilcoxon:** V = `r P300_wil$statistic`, p = `r P300_wil$p.value`, Bonferroni p = `r P300_wil$p.value*14`, r = `r P300_es$effsize` (`r P300_es$magnitude`)   
...
**Wilcoxon:** V = `r P300_lat_wil$statistic`, p = `r P300_lat_wil$p.value`, Bonferroni p = `r P300_lat_wil$p.value*14`, r = `r P300_lat_es$effsize` (`r P300_lat_es$magnitude`)  
...
**Wilcoxon:** V = `r P300_amp_wil$statistic`, p = `r P300_amp_wil$p.value`, Bonferroni p = `r P300_amp_wil$p.value*14`, r = `r P300_amp_es$effsize` (`r P300_amp_es$magnitude`)  
...
#Kendall Correlation
ERN_cor <- cor.test(df_ERN$dif_E, df_ERN$dif_M, method="kendall")
...
**Correlation:** τ = `r ERN_cor$estimate`, p = `r ERN_cor$p.value`, Bonferroni p = `r ERN_cor$p.value*14` 

**Wilcoxon:** V = `r ERN_wil$statistic`, p = `r ERN_wil$p.value`, Bonferroni p = `r ERN_wil$p.value*14`, r = `r ERN_es$effsize` (`r ERN_es$magnitude`)  
...
**Wilcoxon:** V = `r ERN_lat_wil$statistic`, p = `r ERN_lat_wil$p.value`, Bonferroni p = `r ERN_lat_wil$p.value*14`, r = `r ERN_lat_es$effsize` (`r ERN_lat_es$magnitude`)  
...
**Wilcoxon:** V = `r ERN_amp_wil$statistic`, p = `r ERN_amp_wil$p.value`, Bonferroni p = `r ERN_amp_wil$p.value*14`, r = `r ERN_amp_es$effsize` (`r ERN_amp_es$magnitude`)  
