...
## **Number of trials included in analyses**  
...
Mean (SD): `r mean(df_trials$Matched_ErrEp)`(`r sd(df_trials$Matched_ErrEp)`)

  
**Stimulus-locked epochs**   
  
Mean (SD): `r mean(df_trials$Matched_AllEp)`(`r sd(df_trials$Matched_AllEp)`)
