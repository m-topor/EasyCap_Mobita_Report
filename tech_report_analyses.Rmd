...
**Median for EasyCap:** `r raw_low_median_e`  
**Median for Mobita:** `r raw_low_median_m`  
  
**Wilcoxon:** V = `r raw_low_wil$statistic`, p = `r raw_low_wil$p.value`, Bonferroni p = `r raw_low_wil$p.value*8`  
...
**Median for EasyCap:** `r raw_high_median_e`  
**Median for Mobita:** `r raw_high_median_m`  
  
**Wilcoxon:** V = `r raw_high_wil$statistic`, p = `r raw_high_wil$p.value`, Bonferroni p = `r raw_high_wil$p.value*8`  
...
**Median for EasyCap:** `r range_low_median_e`  
**Median for Mobita:** `r range_low_median_m`  
  
**Wilcoxon:** V = `r range_low_wil$statistic`, p = `r range_low_wil$p.value`, Bonferroni p = `r range_low_wil$p.value*8`  
...
**Median for EasyCap:** `r range_high_median_e`  
**Median for Mobita:** `r range_high_median_m`  
  
**Wilcoxon:** V = `r range_high_wil$statistic`, p = `r range_high_wil$p.value`, Bonferroni p = `r range_high_wil$p.value*8`  
...
**Median for EasyCap:** `r stim_rej_median_e`  
**Median for Mobita:** `r stim_rej_median_m`  
  
**Wilcoxon:** V = `r stim_rej_wil$statistic`, p = `r stim_rej_wil$p.value`, Bonferroni p = `r stim_rej_wil$p.value*2`  
...
**Median for EasyCap:** `r SNR_median_e`  
**Median for Mobita:** `r SNR_median_m`  
  
**Wilcoxon:** V = `r SNR_wil$statistic`, p = `r SNR_wil$p.value`, Bonferroni p = `r SNR_wil$p.value*4`  
...
**Median for EasyCap:** `r RMS_median_e`  
**Median for Mobita:** `r RMS_median_m`  
  
**Wilcoxon:** V = `r RMS_wil$statistic`, p = `r RMS_wil$p.value`, Bonferroni p = `r RMS_wil$p.value*4`  
...
theta_cor <- cor.test(df_theta_matched$theta_av_E_log, df_theta_matched$theta_av_M_log, method="spearman")  
...
**Median EasyCap =** `r theta_median_e`     
  
**Median Mobita =** `r theta_median_m`  
  
**Correlation:** r = `r theta_cor$estimate`, p = `r theta_cor$p.value`, Bonferroni p = `r theta_cor$p.value*12`  
  
**Wilcoxon:** V = `r theta_wil$statistic`, p = `r theta_wil$p.value`, Bonferroni p = `r theta_wil$p.value*12`  
...
alpha_cor <- cor.test(df_alpha_matched$alpha_av_E_log, df_alpha_matched$alpha_av_M_log, method="spearman")
...
**Median EasyCap =** `r alpha_median_e`     
  
**Median Mobita =** `r alpha_median_m`  

**Correlation:** r = `r alpha_cor$estimate`, p = `r alpha_cor$p.value`, Bonferroni p = `r alpha_cor$p.value*12`  
  
**Wilcoxon:** V = `r alpha_wil$statistic`, p = `r alpha_wil$p.value`, Bonferroni p = `r alpha_wil$p.value*12`  
...
lbeta_cor <- cor.test(df_lbeta_matched$lbeta_av_E_log, df_lbeta_matched$lbeta_av_M_log, method="spearman")
...
**Median EasyCap =** `r lbeta_median_e`     
  
**Median Mobita =** `r lbeta_median_m`  

**Correlation:** r = `r lbeta_cor$estimate`, p = `r lbeta_cor$p.value`, Bonferroni p = `r lbeta_cor$p.value*12`  
  
**Wilcoxon:** V = `r lbeta_wil$statistic`, p = `r lbeta_wil$p.value`, Bonferroni p = `r lbeta_wil$p.value*12`  
...
hbeta_cor <- cor.test(df_hbeta_matched$hbeta_av_E_log, df_hbeta_matched$hbeta_av_M_log, method="spearman")
...
**Median EasyCap =** `r hbeta_median_e`     
  
**Median Mobita =** `r hbeta_median_m`  

**Correlation:** r = `r hbeta_cor$estimate`, p = `r hbeta_cor$p.value`, Bonferroni p = `r hbeta_cor$p.value*12`  
  
**Wilcoxon:** V = `r hbeta_wil$statistic`, p = `r hbeta_wil$p.value`, Bonferroni p = `r hbeta_wil$p.value*12`  
